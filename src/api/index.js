...
export function read_datasets (formData) {
  return axios({
    method: 'post',
    data: formData,
    url: backUrl + '/api/readdatasets'
  })
}
export function killpricess (formData) {
  return axios({
    method: 'post',
    data: formData,
    url: backUrl + '/api/killprocess'
  })
}
// 获取结果状态
export function getResStatus (formData) {
  return axios({
    method: 'post',
    data: formData,
...
export function getuserDatasets (formdata) {
  return axios({
    method: 'post',
    url: backUrl + '/api/userdataset',
    data: formdata
  })
}

export function getuserDatasetsback (formdata) {
  return axios({
    method: 'post',
    url: backUrl + '/api/userdatasetback',
    data: formdata
  })
}

export function connectus (formdata) {
  return axios({
    method: 'post',
    url: backUrl + '/api/connectus',
    data: formdata
  })
}

export function getDatasetsb (sourceb) {
  return axios({
    cancelToken: sourceb,
    method: 'get',
    url: backUrl + '/api/datasetb'
  })
}
