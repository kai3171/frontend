    ...
    <b-container fluid>
      ...
      <b-row class="my-1">
        ...
        <b-col sm="9">
          ...
          <b-button @click="check" variant="outline-primary">Send CAPTCHA</b-button>
          <b-row class="my-1">
            <b-col>
              <label v-if="EmailMassageShow">Your CAPTCHA have been send,please keep waiting</label>
            </b-col>
          </b-row>
          <b-row class="my-1">
            <b-col>
